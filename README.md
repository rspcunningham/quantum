...
Overall geometric mean across all 780 cells: **5.24x faster** than Aer (156 cases, 5 shot counts). At high shot counts (10K), native is **9.63x faster** (148/156 cases). Even at low shot counts (1-10), native wins 2.99-4.53x. Compilation caching eliminates redundant fusion passes; inverse-pair cancellation collapses all 50 roundtrip circuits to identity in O(n) time.
