...
At high shot counts (10K), native is **1.93x faster** than Aer (94/150 cases). At low shot counts (1-100), Aer's compiled C++ dispatch wins — native is 0.57-0.66x. Overall geometric mean across all 750 cells: **0.83x** (150 common cases, 5 shot counts).
