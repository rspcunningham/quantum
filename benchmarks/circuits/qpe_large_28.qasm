...
cp(8*pi/3) q[2],q[27];
cp(16*pi/3) q[3],q[27];
cp(33.510321638291124) q[4],q[27];
cp(67.02064327658225) q[5],q[27];
cp(134.0412865531645) q[6],q[27];
cp(268.082573106329) q[7],q[27];
cp(536.165146212658) q[8],q[27];
cp(1072.330292425316) q[9],q[27];
cp(2144.660584850632) q[10],q[27];
cp(4289.321169701264) q[11],q[27];
cp(8578.642339402528) q[12],q[27];
cp(17157.284678805056) q[13],q[27];
cp(34314.56935761011) q[14],q[27];
cp(68629.13871522022) q[15],q[27];
cp(137258.27743044044) q[16],q[27];
cp(274516.5548608809) q[17],q[27];
cp(549033.1097217618) q[18],q[27];
cp(1098066.2194435236) q[19],q[27];
cp(2196132.438887047) q[20],q[27];
cp(4392264.877774094) q[21],q[27];
cp(8784529.755548188) q[22],q[27];
cp(17569059.511096377) q[23],q[27];
cp(35138119.022192754) q[24],q[27];
cp(70276238.04438551) q[25],q[27];
cp(140552476.08877102) q[26],q[27];
swap q[0],q[26];
swap q[1],q[25];
swap q[2],q[24];
swap q[3],q[23];
